(()=>{
    ...
    function Tt(e) {
        ...
        for (let o of t)
            r.includes(o) || wt.forEach(s=>s(o));
        for (let o of r)
            t.includes(o) || vt.forEach(s=>s(o));
        t = null,
        r = null,
        n = null,
        i = null
    ...
    function He(e) {
        return new Proxy({},{
            ...
            set: (t,r,n)=>{
                ...
                return i ? i[r] = n : e[e.length - 1][r] = n,
                !0
            }
        })
    }
    ...
    function fe(e, t=()=>{}
        ...
        let r = {
            ...
            _x_interceptor: !0,
            initialize(n, i, o) {
                return e(this.initialValue, ()=>Ir(n, i), s=>Be(n, i, s), i, o)
            }
        };
        return t(r),
        n=>{
    ...
    function Fr(e, t) {
        ...
        ,{scope: i={}, params: o=[]}={})=>{
            ...
            let s = He([i, ...e])
              , a = r(r, s);
            r.finished ? de(n, r.result, s, o) : a.then(c=>{
                de(n, c, s, o)
            }
            )
        }
...
`, e),
    ...
    function X(e, t, r) {
        let n = {};
        return Array.from(t).map(zr((o,s)=>n[o] = s)).filter(Vr).map(Hr(n, r)).sort(Br).map(o=>Kr(e, o))
    }
    var Ge = !1
      , Ye = [];
    function Pt(e) {
    ...
    function Kr(e, t) {
        ...
        Ot(e, t.original, l);
        let u = ()=>{
            e._x_ignore || e._x_ignoreSelf || (n.inline && n.inline(e, t, c),
            n = n.bind(n, e, t, c),
            Ge ? Ye.push(n) : n())
        }
        ;
        return u.runCleanups = l,
        u
    }
    ...
    function $t() {
        document.body || _e("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"),
        ...
        Array.from(document.querySelectorAll(qr())).filter(e).forEach(t=>{
            A(t)
        }
        ),
    ...
    function N(e) {
        if (Kt().some(t=>e.matches(t)))
            return e;
        if (!!e.parentElement)
            return N(e.parentElement)
    }
    function Vt(e) {
    ...
    var ve = e=>{
      ...
      , io = ve(e=>e ? `on${it(e)}` : "")
      , ot = (e,t)=>e !== t && (e === e || t === t);
    var st = new WeakMap, re = [], O, $ = Symbol("iterate"), at = Symbol("Map key iterate");
    function rn(e) {
    ...
    function P(e, t, r, n, i, o) {
        ...
        if (t === "clear")
            ...
            t) {
            case "add":
                D(e) ? be(r) && c(s.get("length")) : (c(s.get($)),
                W(e) && c(s.get(at)));
                break;
            case "delete":
                D(e) || (c(s.get($)),
    ...
    function we(e=!1, t=!1) {
        return function(n, i, o) {
            ...
            let s = D(n);
            if (!e && s && ee(Ee, i))
                return Reflect.get(Ee, i, o);
            let a = Reflect.get(n, i, o);
            return (ye(i) ? nr.has(i) : cn(i)) || (e || v(n, "get", i),
    ...
    function ar(e=!1) {
        return function(r, n, i, o) {
            ...
            return r === g(o) && (a ? ot(i, s) && P(r, "set", n, i, s) : P(r, "add", n, i)),
            c
        }
    }
    function _n(e, t) {
    ...
    function xn(e, t) {
        ...
        return (!ye(t) || !nr.has(t)) && v(e, "has", t),
        r
    }
    function yn(e) {
        return v(e, "iterate", D(e) ? "length" : $),
        Reflect.ownKeys(e)
    }
    var cr = {
        get: ln,
    ...
    function Se(e) {
        return e && e.__v_isReadonly ? e : yr(e, !1, cr, vn, ir)
    }
    function sr(e) {
        return yr(e, !0, lr, wn, or)
    }
    ...
    y("el", e=>e);
    function ne(e, t) {
        return Array.isArray(t) ? br(e, t.join(" ")) : typeof t == "object" && t !== null ? An(e, t) : typeof t == "function" ? ne(e, t()) : br(e, t)
    }
    function br(e, t) {
    ...
    p("transition", (e,{value: t, modifiers: r, expression: n})=>{
        n ? Rn(e, n, t) : Cn(e, r, t)
    }
    );
    function Rn(e, t, r) {
    ...
    function wr(e, t, {during: r, start: n, end: i, entering: o}={}, s=()=>{}
    , a=()=>{}
    ) {
    ...
    function ae(e, t, r, n=[]) {
        switch (e._x_bindings || (e._x_bindings = b({})),
        e._x_bindings[t] = r,
    ...
    function Pn(e, t, r) {
        [null, void 0, !1].includes(r) && jn(t) ? e.removeAttribute(t) : ($n(t) && (r = t),
        Fn(e, t, r))
    }
    function Fn(e, t, r) {
        ...
        (n,i)=>m(()=>{
            ...
            if (e.type === "checkbox")
                if (Array.isArray(i)) {
                    ...
                    return n.target.checked ? i.concat([o]) : i.filter(s=>!Wn(s, o))
                } else
    ...
    function Qn(e, t, r, n) {
        ...
        r(s=>{
            ...
            for (let f = 0; f < d.length; f++) {
                ...
                typeof K == "object" && _e("x-for key cannot be an object, it must be a string or an integer", o),
                a[K] = ue
            }
            for (let f = 0; f < j.length; f++)
                Ve(a[j[f]], l[u.indexOf(j[f])]);
            o._x_prevKeys = u
        }
        )
    }
